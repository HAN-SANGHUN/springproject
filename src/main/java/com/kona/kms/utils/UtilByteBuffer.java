...
public class UtilByteBuffer {
	 ...
	 */
	public UtilByteBuffer(int length) {
	 ...
	 */
	public UtilByteBuffer(byte[] bytes) {
		buffer = bytes;
		length = bytes.length;
	}
	 ...
	 * @return this
	 */
	public UtilByteBuffer append(byte _byte) {
	 ...
	 * @return this
	 */
	public UtilByteBuffer append(byte[] bytes) {
	 ...
	 * @return this
	 */
	public UtilByteBuffer append(UtilByteBuffer bb) {
	 ...
	 */
	public UtilByteBuffer insert(int offset, byte[] bytes, int length) throws IndexOutOfBoundsException {
	 ...
	 */
	public UtilByteBuffer insert(int offset, byte _byte) throws IndexOutOfBoundsException {
	 ...
	 * @throws IndexOutOfBoundsException If offset is not in range
	 */
	public UtilByteBuffer insert(int offset, byte[] bytes) throws IndexOutOfBoundsException {
	 ...
	 * @throws IndexOutOfBoundsException If offset is not in range
	 */
	public UtilByteBuffer insert(int offset, UtilByteBuffer bb) throws IndexOutOfBoundsException {
	 ...
	 * @return this
	 */
	public UtilByteBuffer clear(int offset, int count) throws IndexOutOfBoundsException {
	 ...
	 * @return this
	 */
	public UtilByteBuffer copy(int offset, byte[] source) {
