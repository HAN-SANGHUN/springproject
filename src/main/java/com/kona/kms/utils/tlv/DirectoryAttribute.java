...
public class DirectoryAttribute extends Sequence {
	 ...
	 */
	public DirectoryAttribute(TLVObj tlv) throws TLVEncodingException {
		super(tlv);
		...
		TLVObj oid = findTag(new Tag(Tag.OBJECT_IDENTIFIER), null);
		
		if (oid == null) {
			throw new TLVEncodingException("Object identifier not found");
		}
		
		TLVObj res = findTag(new Tag(0x11, (byte)0x00, true), null);
	 ...
	 */
	public void addElement(TLVObj element) {
	 ...
	 */
	public TLVObj getElement(int tag) {
	...
	public ObjectIdentifier getOID() {
		...
		TLVObj oid = findTag(new Tag(0x06, (byte)0x00, false), null);
