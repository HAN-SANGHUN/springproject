 ...
 */
public abstract class TLVObj implements TreeNode {
	 ...
	 * 			
	 */
	public static TLVObj factory(ParseBuffer pb) throws TLVEncodingException {
		TLVObj newTLV = null;
		Tag newTag = null;
	 ...
	 * 			
	 */
	public static TLVObj factory(byte[] buffer, int offset, int length) throws TLVEncodingException {
	 ...
	 * 			
	 */
	public static TLVObj factory(byte[] buffer) throws TLVEncodingException {
		return factory(new ParseBuffer(buffer, 0, buffer.length));
	}
