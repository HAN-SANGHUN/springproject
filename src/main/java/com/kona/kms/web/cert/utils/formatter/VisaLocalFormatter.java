...
public class VisaLocalFormatter implements ICertiReqFormatter{
	...
	public VisaLocalFormatter(CertificateModel model){
		this.model = model;
	}
	...
	public void format(String modulus, String exponent, String ipkSize, String expSize, String leftmost) {
		...
		ssd.append("23"); 
		// Service Identifier
		ssd.append(VisaLocalFormatter.serviceIdentifier);
		// Certificate Format
		ssd.append("02");  
		// BIN + "FF"
	...
	public String toString() {
		return "VisaLocalFormatter [modulus=" + modulus + ", exponent="
