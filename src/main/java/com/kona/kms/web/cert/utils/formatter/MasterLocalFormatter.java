...
public class MasterLocalFormatter implements ICertiReqFormatter{

	private static final String serviceIdentifier = "20100000";
	...
	public MasterLocalFormatter(CertificateModel model){
		this.model = model;
	}
	...
	public void format(String modulus, String exponent, String ipkSize, String expSize, String leftmost) {		
		...
		ssd.append("23"); 
		// Service Identifier
		ssd.append(MasterLocalFormatter.serviceIdentifier);
		// Certificate Format
		ssd.append("02");  
		// BIN + "FF"
	...
	public String toString() {
		return "MasterLocalFormatter [modulus=" + modulus + ", exponent="
				+ exponent + ", ipkSize=" + ipkSize + ", expSize=" + expSize
