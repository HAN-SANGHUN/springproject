...
@Service
public class CertReqExcelView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		HSSFSheet sheet = workbook.createSheet("Certificate Request List");
		...
		sheet.setColumnWidth(15, 7000); // expire date
		
		sheet.setColumnWidth(16, 7000); // request date
		sheet.setColumnWidth(17, 7000); // registration date
		sheet.setColumnWidth(18, 7000); // registration user
		...
		for(CertificateModel entry : models){
			...
			cell = row.createCell(18);
			cell.setCellStyle(style.get("text"));
			cell.setCellValue(new HSSFRichTextString(entry.getRegistrationUserID()));

		}
		
		String fileName = "certificate_request_list.xls";
