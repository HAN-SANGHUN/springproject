...
import com.kona.kms.crypto.tcp.keyAttrisModel.KeyAttrisImportPubKeyModel;
import com.kona.kms.crypto.tcp.utility.MSGModelConstant;

public class MSGImportPubKeyModel {
	...
	public MSGImportPubKeyModel(ByteBuffer msgBodyBuffer) throws KmsException {
...
//			tokenLabelString = tokenLabelStringTemp.replaceAll(" ", "");
			...
			KeyAttrisImportPubKeyModel keyAttrisImportPubKeyModel = new KeyAttrisImportPubKeyModel(keyAttrisArray);
			keyAttributes = keyAttrisImportPubKeyModel.getKeyAttributes();
		} catch (Exception e){
			e.printStackTrace();
