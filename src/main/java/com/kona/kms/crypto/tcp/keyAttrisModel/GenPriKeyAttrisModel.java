...
public class GenPriKeyAttrisModel {
	...
	public GenPriKeyAttrisModel(KeyAttributes keyAttris){
	...
	public void parseKeyAttris(KeyAttributes keyAttris){
		...
		keyAttrisLen = 32 + 32 + MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13 + 256 + 4 + subjectLenInt + 8 + 8;
		...
		System.arraycopy(startData, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+subjectLenInt, 8);
		System.arraycopy(endData, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+subjectLenInt+8, 8);
