...
import com.kona.kms.crypto.tcp.keyAttrisModel.KeyAttrisImportPriKeyModel;
import com.kona.kms.crypto.tcp.utility.MSGModelConstant;

public class MSGImportPriKeyModel {
	...
	public MSGImportPriKeyModel(ByteBuffer msgBodyBuffer) throws KmsException {
...
//			tokenLabelString = tokenLabelStringTemp.replaceAll(" ", "");
			...
			KeyAttrisImportPriKeyModel keyAttrisImportPriKeyModel = new KeyAttrisImportPriKeyModel(keyAttrisArray);
			keyAttributes = keyAttrisImportPriKeyModel.getKeyAttributes();
		} catch (Exception e){
			e.printStackTrace();
