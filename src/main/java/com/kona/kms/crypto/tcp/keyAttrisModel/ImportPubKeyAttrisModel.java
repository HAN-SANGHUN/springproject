...
public class ImportPubKeyAttrisModel {
	...
	public ImportPubKeyAttrisModel(KeyAttributes keyAttris){
...
//		modulusVal= new byte[Integer.parseInt(modulusLenStr)];
		...
		keyAttrisLen = 32 + 32 + MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13 + 256 + 4 + modulusLenInt + 4 + pubExpLenInt + 4 + subjectLenInt + 8 + 8;
		...
		System.arraycopy(modulusLen, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256, 4);
		if (modulusVal != null){
			System.arraycopy(modulusVal, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4, modulusLenInt);	
		}
		
		
		System.arraycopy(pubExpLen, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt, 4);
		if (pubExpVal != null){
			System.arraycopy(pubExpVal, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt+4, pubExpLenInt);	
		}
		
		System.arraycopy(subjectLen, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt+4+pubExpLenInt, 4);
		if (subjectVal != null){
			System.arraycopy(subjectVal, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt+4+pubExpLenInt+4, subjectLenInt);	
		}
		
		
		System.arraycopy(startData, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt+4+pubExpLenInt+4+subjectLenInt, 8);
		System.arraycopy(endData, 0, keyAttrisArray, 32+32+MSGModelConstant.KEY_ATTRS_BOOLEAN_LEN*13+256+4+modulusLenInt+4+pubExpLenInt+4+subjectLenInt+8, 8);
