...
//	}
//	
//	public String C_GenerateKey(String tokenLabel, String mechanism,
//			String[] keyAttrs) throws KmsException {
...
//	}
//
//	public String[] C_GenerateKeyPair(String tokenLabel, String mechanism,
//			String[] pubKeyAttrs, String[] priKeyAttrs) throws KmsException {
//		logger.debug("KmsCryptoServiceImpl::C_GenerateKeyPair: ...........\n");
//
//		CryptoRequest request = new CryptoRequest();
//		request.tokenLabel = tokenLabel;
//		request.PubKeyAttr = KeyAttrMgmt.getInstance().parseUsageParams(
//				pubKeyAttrs);
//		request.PriKeyAttr = KeyAttrMgmt.getInstance().parseUsageParams(
//				priKeyAttrs);
//		request.mechanism = mechanism;
//		// request.mechanismParameters = mechanismParameters;
//
...
//	}
//
//	public String C_ImportSecretKey(String tokenLabel, String mechanism,
//			String[] keyAttrs) throws KmsException {
...
//	}
//
//	public String C_ImportPublicKey(String tokenLabel, String mechanism,
//			String[] keyAttrs) throws KmsException {
...
//	}
//
//	public String C_ImportPrivateKey(String tokenLabel, String mechanism,
//			String[] keyAttrs) throws KmsException {
...
//	}
//
//	public byte[] C_Encrypt(String mechanism, String[] mechanismParameters, String keyLabel, byte[] data) throws KmsException {
...
//	}
//
//	public byte[] C_Decrypt(String mechanism, String[] mechanismParameters,
//			String keyLabel, byte[] data) throws KmsException {
...
//	}
//
//	public byte[] C_Digest(String mechanism, String[] mechanismParameters,
//			byte[] data) throws KmsException {
...
//		request.mechanism = mechanism;
//		
//		logger.debug("KmsCryptoServiceImpl::C_Digest: ...........mechanism: " + request.mechanism);
//		
//		request.mechanismParameters = mechanismParameters;
//		
//		//String mechanismParametersString = Arrays.toString(request.mechanismParameters).toString();
//		
//		logger.debug("KmsCryptoServiceImpl::C_Digest: ...........mechanismParameters: " + request.mechanismParameters[0]);
//		
//		request.data = data;
//		
//		String dataString = new String(request.data);
//		
//		logger.debug("KmsCryptoServiceImpl::C_Digest: ...........data: " + dataString);
//
...
//	}
//
//	public byte[] C_Sign(String mechanism, String[] mechanismParameters,
//			String keyLabel, byte[] data) throws KmsException {
...
//	}
//
//	public boolean C_Verify(String mechanism, String[] mechanismParameters,
//			String keyLabel, byte[] data, byte[] signature) throws KmsException {
...
//	}
//
//	public byte[] C_WrapKey(String mechanism, String[] mechanismParameters,
//			String wrappingKeyLabel, String keyLabel) throws KmsException {
...
//	}
//
//	public String C_UnwrapKey(String mechanism, String[] mechanismParameters,
//			String unWrappingKeyLabel, byte[] wrappedKey, String[] keyAttrs)
//			throws KmsException {
...
//	}
//
//	public String C_DeriveKey(String mechanism, String[] mechanismParameters,
//			String baseKeyLabel, String[] keyAttrs) throws KmsException {
...
//			KeyProfile keyProfile = msgHandler.unmarshal(inMsg, "KeyProfile",
//					KeyProfile.class);
//
//			logger.debug(
//					"KmsCryptoServiceImpl::dataXfer: KeyProfile desc : {}",
//					keyProfile.getDescription());
//			logger.debug(
//					"KmsCryptoServiceImpl::dataXfer: KeyProfile type : {}/{}",
//					keyProfile.getKeyInfo().getType(), keyProfile.getKeyInfo()
//							.getSubType());
//
...
//	// /////////////////////////////////////////////////////////////////////////////////////////////////
//
//	public KeyAttributes GenerateKey(String tokenLabel, String mechanism,
//			KeyAttributes keyAttrs) throws KmsException {
...
//		CryptoRequest request = new CryptoRequest();
//		request.tokenLabel = tokenLabel;
//		request.keyAttr = KeyAttrMgmt.getInstance().validateKeyAttribubute(
//				keyAttrs);
//		request.mechanism = mechanism;
//
//		CryptoResponse response = crtBo.generateKey(request);
...
//	}
//
//	public KeyAttributes[] GenerateKeyPair(String tokenLabel, String mechanism,
//			KeyAttributes pubKeyAttrs, KeyAttributes priKeyAttrs)
//			throws KmsException {
//		// TODO Auto-generated method stub
...
//		CryptoRequest request = new CryptoRequest();
//		request.tokenLabel = tokenLabel;
//		request.PubKeyAttr = KeyAttrMgmt.getInstance().validateKeyAttribubute(
//				pubKeyAttrs);
//		request.PriKeyAttr = KeyAttrMgmt.getInstance().validateKeyAttribubute(
//				priKeyAttrs);
//		request.mechanism = mechanism;
//
//		CryptoResponse response = crtBo.generateKeyPair(request);
...
//	}
//
//	public KeyAttributes ImportSecretKey(String tokenLabel, String mechanism,
//			KeyAttributes keyAttrs) throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public KeyAttributes ImportPublicKey(String tokenLabel, String mechanism,
//			KeyAttributes keyAttrs) throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public KeyAttributes ImportPrivateKey(String tokenLabel, String mechanism,
//			KeyAttributes keyAttrs) throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public KeyAttributes UnwrapKey(String mechanism,
//			String[] mechanismParameters, String unWrappingKeyLabel,
//			byte[] wrappedKey, KeyAttributes keyAttrs) throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public KeyAttributes DeriveKey(String mechanism,
//			String[] mechanismParameters, String baseKeyLabel,
//			KeyAttributes keyAttrs) throws KmsException {
//		// TODO Auto-generated method stub
...
//		CryptoResponse response = crtBo.getAttributeValue(request);
//		
//		KeyAttributes keyAttrs = KeyAttrMgmt.getInstance().parseUsageParams(
//				response.attrs);
//		return keyAttrs;
//	}
//
...
//		logger.debug(
//				"KmsCryptoServiceImpl::generateRandom: start..... size[{}]",
//				size);
//
//		CryptoRequest request = new CryptoRequest();
//		request.size = size;
...
//
//		KeyAttributes keyAttrs = KeyAttrMgmt.getInstance()
//				.convKey2KeyAttributes(key);
//
//		if (keyAttrs.cka_label == null) {
//			String tmpLabel = "Key" + UUIDGenerator.getNewId();
//			keyAttrs.cka_label = tmpLabel.getBytes();
...
//	}
//
//	public Key[] C_GenerateKeyPair3(String tokenLabel, String mechanism,
//			Key pubKey, Key priKey) throws KmsException {
//		// TODO Auto-generated method stub
//		logger.debug("KmsCryptoServiceImpl::C_GenerateKeyPair(v3): ...........\n");
//
//		KeyAttributes pubKeyAttrs = KeyAttrMgmt.getInstance()
//				.convKey2KeyAttributes(pubKey);
//		KeyAttributes priKeyAttrs = KeyAttrMgmt.getInstance()
//				.convKey2KeyAttributes(priKey);
//
//		if (pubKeyAttrs.cka_label == null) {
//			String tmpLabel = "Key" + UUIDGenerator.getNewId();
//			pubKeyAttrs.cka_label = tmpLabel.getBytes();
...
//	}
//
//	public Key C_ImportSecretKey3(String tokenLabel, String mechanism, Key key)
//			throws KmsException {
//		// TODO Auto-generated method stub
//		logger.debug("KmsCryptoServiceImpl::C_ImportSecretKey(v3): ...........\n");
//
...
//	}
//
//	public Key C_ImportPublicKey3(String tokenLabel, String mechanism, Key key)
//			throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public Key C_ImportPrivateKey3(String tokenLabel, String mechanism, Key key)
//			throws KmsException {
//		// TODO Auto-generated method stub
...
//	}
//
//	public Key C_UnwrapKey3(String mechanism, String[] mechanismParameters,
//			String unWrappingKeyLabel, byte[] wrappedKey, Key key)
//			throws KmsException {
//		// TODO Auto-generated method stub
//		logger.debug("KmsCryptoServiceImpl::C_UnwrapKey(v2): ...........\n");
//
...
//	}
//
//	public Key C_DeriveKey3(String mechanism, String[] mechanismParameters,
//			String baseKeyLabel, Key key) throws KmsException {
//		// TODO Auto-generated method stub
//		logger.debug("KmsCryptoServiceImpl::C_DeriveKey(v2): ...........\n");
//
//		KeyAttributes keyAttrs = KeyAttrMgmt.getInstance()
...
//	}
//
//	public byte[] C_Encrypt_v2(String mechanism, String[] mechanismParameters,
//			String keyLabel, byte[] data, String tokenLabel)
//			throws KmsException {
