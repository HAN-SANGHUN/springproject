...
function grid_init(){
	$("#jq_grid").jqGrid({
		...
		datatype:'json',
		mtype: 'POST',
		colNames : ['Company','Profile ID','Profile Name','Version','Key Label','Reg.Date','Expire Date', 'Key Subject'],
		colModel : [
		   ...
		   {name:'registrationDateStr', index:'registrationDate',width:100},
		   {name:'expireDateStr', index:'expireDate',width:100},
