...
<head>
	<title>Edit Key Profile</title>
	<script type="text/javascript" src="/js/profile/profile_edit_pair.js"></script>
</head>

<body>
 	<!-- Header -->
   	<div id="pop-con_top">
       	<h1>Edit Key Profile</h1>
   	</div>
	<!-- //Header --> 
	...
	<div id="pop-main" style="height:85%;">
		...
		<input type="hidden" name="oldKeyProfileVersion" id="oldKeyProfileVersion" value="${profile.keyProfileVersion}" />
		<div class="floatR">
				...
				<li>
					...
					<table class="Table-Style_pop2  txtL" style="width:250px; margin-top:2px;">
						...
						<tbody>
						  ...
						  <tr>
						  	<th>Key Type</th>
							<td><input type="text" name="keyTypeCode" id="keyTypeCode" value="PAIR KEY" readonly style="background-color:#F0F0F0;"/></td>
							<th>Key Sub Type</th>
							<td>
								<c:choose>
											...
											<tr>
												...
												<td>
													<select name="keySize" id="keySize">
														<option value="768" <c:if test="${profile.keySize eq 768}">selected</c:if>>768</option>
														<option value="1024" <c:if test="${profile.keySize eq 1024}">selected</c:if>>1024</option>
														<option value="1152" <c:if test="${profile.keySize eq 1152}">selected</c:if>>1152</option>
														<option value="1408" <c:if test="${profile.keySize eq 1408}">selected</c:if>>1408</option>
														<option value="2048" <c:if test="${profile.keySize eq 2048}">selected</c:if>>2048</option>
													</select>
												</td>
											</tr>
											<tr>
								...
								<td>
									...
									<table class="Table-Style_pop2  txtL" style="width:250px;">
										...
										<tbody>
											<tr>
											  	<th>Key Label</th>
												<td><textarea rows="2" name="keyLabel1" id="keyLabel1" maxlength="128" readonly style="background-color:#F0F0F0;width:90%;">${profile1.keyLabel}</textarea></td>
											</tr>
											<tr>
											  	<th>Key Size (bits)</th>
												<td>
													<select name="keySize1" id="keySize1">
														<option value="768" <c:if test="${profile1.keySize eq 768}">selected</c:if>>768</option>
														<option value="1024" <c:if test="${profile1.keySize eq 1024}">selected</c:if>>1024</option>
														<option value="1152" <c:if test="${profile1.keySize eq 1152}">selected</c:if>>1152</option>
														<option value="1408" <c:if test="${profile1.keySize eq 1408}">selected</c:if>>1408</option>
														<option value="2048" <c:if test="${profile1.keySize eq 2048}">selected</c:if>>2048</option>
													</select>
												</td>
											</tr>
											<tr>
									...
									<c:set var="attr" value="${profile1.keyValueAttribute}" />
									<table class="Table-Style_pop2  txtL" style="width:250px; margin-top:5px;">
										<colgroup>
											<col style="width:133px"/>
											<col style="width:133px"/>
										...
										<tbody>
											<tr>
												<td><input type="checkbox" name="importable1" id="importable1" <c:if test="${attr.importable}">checked</c:if>> Importable</td>
												<td><input type="checkbox" name="exportable1" id="exportable1" <c:if test="${attr.exportable}">checked</c:if>> Exportable</td>
												<td><input type="checkbox" name="sensitive1" id="sensitive1" <c:if test="${attr.sensitive}">checked</c:if>> Sensitive</td>
											</tr>
											<tr>
												<td><input type="checkbox" name="encrypt1" id="encrypt1" <c:if test="${attr.encrypt}">checked</c:if>> Encrypt</td>
												<td><input type="checkbox" name="decrypt1" id="decrypt1" <c:if test="${attr.decrypt}">checked</c:if>> Decrypt</td>
												<td><input type="checkbox" name="encryptDecrypt1" id="encryptDecrypt1" <c:if test="${attr.encryptDecrypt}">checked</c:if>> Encrypt/Decrypt</td>
											</tr>
											<tr>
												<td><input type="checkbox" name="wrap1" id="wrapp1" <c:if test="${attr.wrap}">checked</c:if>> Wrap</td>
												<td><input type="checkbox" name="unwrap1" id="unwrap1" <c:if test="${attr.unwrap}">checked</c:if>> Unwrap</td>
												<td><input type="checkbox" name="wrapUnwrap1" id="wrapUnwrap1" <c:if test="${attr.wrapUnwrap}">checked</c:if>> Wrap/Unwrap</td>
											</tr>
											<tr>
												<td><input type="checkbox" name="sign1" id="sign1" <c:if test="${attr.sign}">checked</c:if>> Sign</td>
												<td><input type="checkbox" name="verify1" id="verify1" <c:if test="${attr.verify}">checked</c:if>> Verify</td>
												<td><input type="checkbox" name="derive1" id="derive1" <c:if test="${attr.derive}">checked</c:if>> Derive</td>
											</tr>
										</tbody>
									</table>
								</td>
								...
								<td>
									...
									<table class="Table-Style_pop2  txtL" style="width:250px;">
										...
										<tbody>
											<tr>
											  	<th>Profile ID</th>
												<td><input type="text" name="keyProfileID" id="keyProfileID" value="${profile.keyProfileID}" maxlength="40" placeholder="system input" readonly style="background-color:#F0F0F0;"/></td>
											</tr>
											<tr>
											  	<th>Profile Version</th>
												<td><input type="text" name="keyProfileVersion" id="keyProfileVersion" value="${profile.keyProfileVersion}" placeholder="system input" maxlength="512" /></td>
											</tr>
											<tr>
											  	<th>Profile Name</th>
								...
								<td>
									...
									<table class="Table-Style_pop2  txtL" style="width:250px;">
										...
										<tbody>
											<tr>
											  	<th>Profile ID</th>
												<td><input type="text" name="keyProfileID1" id="keyProfileID1" value="${profile1.keyProfileID}" maxlength="40" placeholder="system input" readonly style="background-color:#F0F0F0;"/></td>
											</tr>
											<tr>
											  	<th>Profile Version</th>
												<td><input type="text" name="keyProfileVersion1" id="keyProfileVersion1" value="${profile1.keyProfileVersion}" maxlength="512" /></td>
											</tr>
											<tr>
											  	<th>Profile Name</th>
												<td><input type="text" name="keyProfileName1" id="keyProfileName1" value="${profile1.keyProfileName}" maxlength="128"/></td>
											</tr>
											<tr>
												<th>Description</th>
												<td><input type="text" name="description1" id="description1" value="${profile1.description}" maxlength="512"/></td>
											</tr>
										</tbody>
									</table>									
								</td>
					...
					<div style="color:#24a8c1; margin-top:15px;font-size:12px;font-weight:bold;">
						<i class="icon-chevron-sign-right"></i> Revision Description
					</div>
					<table class="Table-Style_pop2  txtL" style="width:250px; margin-top:5px;">
						<colgroup>
							<col style="width:175px"/>
						...
						<tbody>
							<tr>
								<th>Description </th>
								<td colspan="3"><input type="text" name="revisionDescription" id="revisionDescription" /></td>
							</tr>
						</tbody>
					</table>					
				</li>
